...
class _SettingsFormState extends State<SettingsForm> {
  ...
  String displayTaskNotificationDays;
  String displayLeaseNotificationDays;
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    TextFormField(
                      ...
                      decoration:
                          kTextInputDecoration.copyWith(hintText: 'your name'),
                      validator: (val) =>
...
//                            '${_currentLeaseNotificationDays ?? userData.leaseNotificationDays}',
                      ...
                      onChanged: (newVal) => setState(
                        () {
                          ...
                          displayLeaseNotificationDays =
                              _currentLeaseNotificationDays.toString();
                        },
                      ),
                    ),
                  ],
